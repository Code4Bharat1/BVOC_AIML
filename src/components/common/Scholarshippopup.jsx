...
const socialLinks = [
  ...
  { icon: FaWhatsapp, url: 'https://wa.me/9892398976', label: 'WhatsApp' },
];
...
const RegistrationForm = ({ onClose, onSuccess }) => {
  ...
  const sendWhatsApp = () => {
    ...
    window.open(
      `https://wa.me/9892398976?text=${encodeURIComponent(msg)}`,
      '_blank',
    );
  };
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="md:hidden p-5 pb-0 flex justify-center">
        <Image
          ...
          width={140}
          height={50}
          className="object-contain h-auto max-h-[46px]"
          priority
        />
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-5 sm:p-6 md:p-10">
        <div className="mb-6">
          ...
          <p className="text-[12px] sm:text-[13px] text-slate-500">
            Fill in your details to apply for the ₹25,00,000 Scholarship
            Examination
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 mb-7">
          {[1, 2].map((s) => (
            <div key={s} className="flex items-center gap-2">
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center text-[12px] font-black transition-all ${currentStep >= s ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-400'}`}
              >
                {s}
              </div>
              {s < 2 && (
                <div
                  className={`h-0.5 w-14 sm:w-20 rounded-full transition-all ${currentStep > s ? 'bg-slate-900' : 'bg-slate-200'}`}
                />
              )}
            </div>
          ))}
            ...
            >
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <div className="w-14 px-3 py-3 bg-slate-100 border border-slate-200 rounded-xl flex items-center justify-center text-[13px] font-bold text-slate-600">
                    +91
                  </div>
                  <input
                    type="tel"
            ...
            >
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 text-[13px] border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none bg-white"
                  required
                >
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
                <p className="text-[11px] font-black text-slate-400 tracking-wider uppercase mb-3">
                  📋 Summary
                </p>
                  ...
                  {[
                    ...
                    val ? (
                      <div key={label} className="flex gap-2">
                        <span className="font-bold text-slate-700 w-24 flex-shrink-0">
                          {label}:
                        </span>
              ...
              <div className="flex gap-2.5">
                ...
                <button
                  type="submit"
                  disabled={
                    !formData.qualification || !formData.courseInterested
                  }
...
const SuccessScreen = ({ formData, onClose }) => (
  ...
  >
    ...
    <h3 className="text-[22px] sm:text-[26px] font-black text-slate-900 mb-3">
      Registration Successful!
    </h3>
    <p className="text-[13px] sm:text-[14px] text-slate-500 mb-6">
      Thank you,{' '}
      <strong className="text-slate-800">{formData.studentName}</strong>! Your
    ...
    <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 mb-6 text-left max-w-sm mx-auto">
      ...
      <ul className="space-y-2 text-[12px] text-slate-600">
        <li>
          • We'll contact you on +91 {formData.whatsappNumber} within 24 hours
        </li>
        <li>
          • Course details for{' '}
          <strong>
            {formData.courseInterested?.split(' ').slice(0, 3).join(' ')}…
          </strong>{' '}
          will be shared
        </li>
...
const ScholarshipPopup = () => {
                  ...
                  >
                    ...
                    <div className="relative z-10 mb-5 w-full bg-white rounded-xl p-2.5 flex items-center justify-center shadow-lg">
                      <Image
                        ...
                        width={200}
                        height={80}
                        className="object-contain w-full h-auto max-h-[68px]"
                        priority
                      />
                    </div>
                    ...
                    <div className="relative z-10 flex items-center gap-3 mb-4">
                      ...
                      <span className="text-red-400 text-[10px] font-black tracking-widest uppercase">
                        Closing Soon
                      </span>
                    </div>
                    ...
                    <p className="relative z-10 text-slate-400 text-[11.5px] leading-relaxed mb-4">
                      Supporting deserving students to build a future in
                    ...
                    <div className="float-box relative z-10 bg-blue-600 rounded-2xl px-4 py-4 mb-3 text-center shadow-lg shadow-blue-900/40">
                      <p className="text-[9px] font-black text-blue-200 tracking-[0.18em] mb-1 uppercase">
                        Total Scholarship Pool
                      </p>
                      <p className="text-[28px] font-black text-white leading-none tracking-tight">
                        ₹25,00,000/-
                      </p>
                      <p className="text-[9px] text-blue-200 font-semibold mt-1.5">
                    ...
                    <div className="relative z-10 bg-orange-500/10 border border-orange-500/30 rounded-xl px-3 py-2.5 mb-3 text-center">
                      <p className="text-[8px] font-black text-slate-400 tracking-widest mb-0.5 uppercase">
                        Exam Dates
                      </p>
                      <p className="text-[13px] font-black text-orange-400">
                    ...
                    <div className="relative z-10 mb-3">
                      <p className="text-[8px] font-black text-slate-500 tracking-widest mb-2 uppercase">
                        Eligible Programs
                      </p>
                    ...
                    <span className="relative z-10 text-slate-600 text-[9px]">
                      Nexcore · Since 2011
                    </span>

                    {/* Social */}
                    <div className="relative z-10 mt-auto pt-4">
                      <p className="text-slate-500 text-[9px] mb-2 font-medium">
                        Follow for updates
                      </p>
                        ...
                        <div className="p-4 sm:p-5 md:p-8 flex flex-col gap-3 sm:gap-3.5">
                          ...
                          <div className="md:hidden flex justify-center pt-0.5">
                            <Image
                              ...
                              width={150}
                              height={60}
                              className="object-contain h-auto max-h-[50px]"
                              priority
                            />
                          </div>
                          ...
                          <div>
                           ...
                           <p className="text-[20px] sm:text-[18px] font-extrabold text-gradient bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent tracking-widest uppercase">
  Free Examination and Counseling
                          ...
                          >
                            <p className="text-[9px] sm:text-[10px] font-black text-blue-200 tracking-[0.18em] mb-1.5 uppercase">
                              Total Scholarship Pool
                            </p>
                            <div className="amount-fluid font-black text-white leading-none tracking-tight">
                              ₹25,00,000/-
                            </div>
                            <p className="text-[10px] sm:text-[11px] text-blue-200 font-semibold mt-2">
                              🏅 Twenty Five Lakh Rupees
                            </p>
                          </motion.div>
                          ...
                          >
                            ...
                            <div className="flex flex-col gap-2">
                              {programs.map((p) => (
                                ...
                                >
                                  <div
                                    className={`w-8 h-8 flex-shrink-0 rounded-lg ${p.iconBg} flex items-center justify-center text-base`}
                                  >
                                    {p.emoji}
                                  </div>
                                  <div className="min-w-0">
                                    <div className="text-[11px] sm:text-[12px] font-black text-slate-800 leading-tight">
                                      {p.name}
                                    </div>
                                    <div
                                      className={`text-[9px] ${p.textColor} font-semibold mt-0.5`}
                                    >
                                      {p.badge}
                                    </div>
                                  </div>
                          ...
                          <div className="grid grid-cols-2 gap-2 sm:gap-3">
                            ...
                            >
                              <div className="text-[8px] font-black text-orange-700 tracking-wider mb-1 uppercase">
                                Exam Dates
                              </div>
                              <div className="text-[13px] sm:text-[15px] font-black text-slate-900 mb-2 leading-tight">
                                27–29
                                <br />
                                March
                              </div>
                              ...
                              <div className="text-[8px] text-orange-600 font-bold mt-1.5">
                                Any one date
                              </div>
                            </motion.div>
                            ...
                            >
                              <div>
                                <div className="text-[8px] font-black text-red-700 tracking-wider mb-1 uppercase">
                                  Reg. Closes
                                </div>
                                <div className="text-[13px] sm:text-[15px] font-black text-slate-900 mb-1 leading-tight">
                                  25th March
                                  <br />
                                  2026
                                </div>
                          ...
                          <div className="md:hidden pt-3 border-t border-slate-100">
                            <p className="text-center text-slate-400 text-[10px] mb-2 font-medium">
