    ...
    <>
      ...
      <main className="min-h-screen bg-[#F4F7FC] pt-20 relative overflow-hidden">
        ...
        <div
          ...
          style={{
            background: `radial-gradient(ellipse 60% 40% at 50% 0%, ${c.bgGlow}, transparent 70%)`,
          }}
        />
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{
                  background: `radial-gradient(circle, ${c.color2}, transparent 70%)`,
                }}
              />
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-6">
                ...
                <div className="flex-1">
                  <div className="flex flex-wrap items-center gap-3 mb-2">
                    <h2 className="text-gray-800 text-2xl sm:text-3xl font-black tracking-tight">
                      {c.name}
                    </h2>
                    <span
