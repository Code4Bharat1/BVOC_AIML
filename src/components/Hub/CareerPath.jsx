          ...
          <div className="relative w-full max-w-lg">
            ...
            <div className="relative overflow-hidden border-2 border-white bg-white shadow-xl rounded-lg">
              ...
              >
                <Image
                  src="/CareerPath1.png"
                  alt="Professional career journey pathway"
                  width={520}
                  height={520}
        ...
        >
          ...
          <div className="space-y-5">
            <p className="text-slate-600 text-base lg:text-lg leading-relaxed">
              ...
              or aiming for an advanced role, our programs offer a clear path
              to exciting opportunities at every stage of your career.
            </p>
              ...
              <div className="flex flex-wrap gap-2.5">
                {programs.map((program, idx) => (
                  ...
                  >
                    ...
                    <div
                      className={`absolute inset-0 bg-gradient-to-r ${program.color} opacity-0 group-hover:opacity-10 transition-opacity duration-300 rounded`}
                    />
