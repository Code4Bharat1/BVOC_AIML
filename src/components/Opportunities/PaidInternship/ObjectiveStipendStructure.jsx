...
const ObjectiveStipendStructure = () => {
  ...
  return (
    <>
      ...
      <Head>
        <title>
          Paid Internship Policy & Stipend Structure | B.Voc AI & ML Program
        </title>

        <meta
          name="description"
          content="Understand the objective and stipend structure of the B.Voc AI & ML paid internship program. Students gain industry exposure and earn stipends ranging from ₹3,000 to ₹10,000 per month."
        />

        <meta
          name="keywords"
          content="AI ML paid internship, internship stipend AI ML students, B.Voc AI ML internship stipend, AI ML internship policy, paid internship program AI ML students, AI ML internship stipend structure"
        />
        ...
        <meta
          property="og:title"
          content="Paid Internship Policy & Stipend Structure | B.Voc AI & ML Program"
        />
        <meta
          property="og:description"
          content="Explore the objectives and stipend structure for the B.Voc AI & ML paid internship program designed to bridge academic learning with industry experience."
        />
        <meta
          property="og:url"
        ...
        <meta
          ...
          content="Learn how the AI & ML internship program supports students with industry experience and performance-based stipends."
        />
        <meta
          name="twitter:image"
          content="https://yourdomain.com/og-image.jpg"
          ...
          <div className="flex flex-col gap-6">
            <div className="group relative">
              ...
              <div className="relative bg-gradient-to-r from-cyan-600/15 to-purple-700/15 text-white p-4 md:p-6 rounded-2xl border-2 border-cyan-400/70 w-[300px] md:w-[500px] text-center font-semibold text-sm md:text-base backdrop-blur-sm shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40 transition-all">
                Paid internships will be performance-based, with stipends
                ranging between ₹3,000 to ₹10,000 per month.
              </div>
            </div>
