...
import { FaGraduationCap, FaFlask, FaUsers, FaCheckCircle, FaWhatsapp, FaLaptopCode, FaMedal, FaTrophy } from "react-icons/fa";
...
const programs = [
  { icon: FaLaptopCode,  title: "Joint Workshops",         desc: "Monthly hands-on technical workshops co-conducted by IIT Bombay faculty and industry experts.", color: "#6B21A8" },
  { icon: MdScience,     title: "Research Exposure",        desc: "Selected Nexcore students get research lab visits and project collaborations at IIT Bombay.",   color: "#7C3AED" },
  { icon: GiTeacher,     title: "Guest Lectures",           desc: "Regular guest lectures from IIT Bombay professors covering advanced engineering topics.",       color: "#5B21B6" },
  { icon: FaFlask,       title: "Lab Access Program",       desc: "Students can access specialized IIT Bombay labs for final year projects and internships.",       color: "#4C1D95" },
  { icon: HiAcademicCap, title: "Mentorship Program",       desc: "1-on-1 mentorship from IIT Bombay alumni working in top product companies and research roles.", color: "#7C3AED" },
  { icon: MdBiotech,     title: "Innovation Challenges",    desc: "Participate in IIT Bombay's Techfest and E-Summit representing Nexcore Institute.",             color: "#6D28D9" },
];
...
const timeline = [
  { year: "2022", event: "Partnership MoU signed between Nexcore & IIT Bombay" },
  { year: "2023", event: "First batch of students visited IIT Bombay research labs" },
  { year: "2024", event: "Joint certification program launched for B.Voc students" },
    ...
    <>
      ...
      <main className="min-h-screen bg-[#FAF5FF] relative overflow-hidden">
        ...
        <div className="fixed -bottom-24 -right-24 w-80 h-80 rounded-full pointer-events-none z-0"
          style={{ background: "radial-gradient(circle, rgba(109,40,217,0.07), transparent 70%)" }} />
        ...
        <div className="relative z-10"
          ...
          <div className="relative overflow-hidden pt-32 pb-16 px-5"
            ...
            <HiAcademicCap className="absolute -right-10 top-10 text-white opacity-[0.06]" style={{ fontSize: 280 }} />
            ...
            <div className="max-w-5xl mx-auto relative z-10">
              <div className="inline-flex items-center gap-2 bg-white/20 border border-white/30 rounded-full px-4 py-1.5 text-[11px] font-bold text-white tracking-widest uppercase mb-6">
                <BsStarFill className="text-yellow-300" /> Academic Excellence Partnership
              </div>

              {/* Logos */}
              <div className="flex items-center gap-4 mb-6 flex-wrap">
                <div className="bg-white rounded-2xl px-5 py-3 shadow-lg">
                  <p className="text-purple-800 font-black text-lg leading-none">IIT</p>
              ...
              <h1 className="text-5xl sm:text-6xl font-black text-white tracking-tight leading-none mb-4">
                Excellence Through<br /><span className="text-purple-200">IIT Collaboration</span>
              </h1>
              <p className="text-white/70 text-base sm:text-lg font-medium mb-8 max-w-lg">
                Nexcore's academic partnership with IIT Bombay — one of India's premier institutions — gives our students access to world-class research, mentorship, and technical exposure.
              </p>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
            ...
            <div className="mb-12">
              <h2 className="text-gray-800 text-2xl font-black mb-1 flex items-center gap-2">
                <HiLightningBolt className="text-purple-500" /> What This Partnership Offers
              </h2>
              <p className="text-gray-400 text-sm mb-7">Exclusive academic benefits for Nexcore students</p>
                ...
                <div className="relative pl-4">
                  ...
                  {timeline.map((t, i) => (
                    <div key={t.year} className="relative mb-6 last:mb-0">
                      ...
                      <p className="text-purple-600 text-[11px] font-black tracking-widest mb-1">{t.year}</p>
            ...
            {/* CTA */}
            <div className="rounded-2xl p-8 sm:p-10 text-center border border-purple-100 relative overflow-hidden"
              style={{ background: "linear-gradient(135deg, #F5F3FF, #EDE9FE)" }}>
              <div className="absolute inset-0 opacity-[0.04]"
                style={{ backgroundImage: "repeating-linear-gradient(45deg, #7C3AED 0, #7C3AED 1px, transparent 0, transparent 50%)", backgroundSize: "16px 16px" }} />
              <FaMedal className="text-5xl mx-auto mb-3 text-purple-500 relative z-10" />
              <h3 className="text-gray-800 text-2xl font-black mb-2 relative z-10">Want to Know More?</h3>
              <p className="text-gray-500 text-sm mb-6 max-w-md mx-auto relative z-10">
                Talk to us about how the IIT Bombay collaboration can boost your academic journey at Nexcore.
              </p>
              <a href="https://wa.me/919594402822?text=Hi%2C%20I%20want%20to%20know%20more%20about%20Nexcore%27s%20IIT%20Bombay%20partnership%20program."
                ...
                style={{ background: "linear-gradient(135deg, #6D28D9, #7C3AED)", boxShadow: "0 8px 24px rgba(109,40,217,0.3)" }}>
