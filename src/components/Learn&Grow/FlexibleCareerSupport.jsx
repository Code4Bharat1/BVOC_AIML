    ...
    <>
      ...
      <div className="hidden lg:block overflow-x-hidden overflow-y-hidden">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative bg-gradient-to-b from-white via-slate-50 to-blue-50 p-10 overflow-hidden my-1"
        >
          {/* Heading */}
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="text-left  z-10 relative pl-6 lg:pl-16"
          >
            <h1 className="text-slate-700 text-4xl lg:text-5xl font-bold">
        ...
        <motion.div
          ...
          className="text-start pl-6 lg:pl-24 bg-gradient-to-b from-white via-slate-50 to-blue-50 pb-8 relative"
        >
          <div className="relative z-10">
            <h1 className="text-slate-700 text-2xl lg:text-5xl font-bold pt-8">
              <span className="text-blue-600">Nexcore</span> Alliance LLP –{" "}
              <br className="lg:hidden" />A Clear Path Forward
            </h1>
            <p className="text-slate-600 text-xl lg:text-3xl pt-4 mb-10">
              With exit points tailored to your goals, our{" "}
              <span className="text-orange-600 font-semibold">NSQF-certified</span>{" "}
            ...
            <Link
              href="/contact"
              className="inline-block px-8 py-3 font-semibold rounded-full text-white bg-blue-600 hover:bg-blue-700 transition shadow-lg"
            >
              Explore More
            </Link>
          </div>
      ...
      <div className="block lg:hidden overflow-x-hidden relative">
        {/* Background */}
        <div className="absolute inset-0 bg-gradient-to-b from-white via-slate-50 to-blue-50"></div>

        {/* Heading */}
        <div className="relative mt-20 text-start pl-6 lg:pl-24 z-10">
          <h1 className="text-slate-700 text-2xl lg:text-5xl font-bold text-center">
            Flexible Career Support
          </h1>
        </div>
        ...
        <div className="relative w-full max-w-xs h-[600px] mx-auto overflow-x-hidden z-10">
          ...
          <motion.div
            className="absolute top-[95px] left-10 text-blue-600 text-20px font-bold"
            initial={{ x: -100, opacity: 0 }}
            whileInView={{ x: 0, opacity: 1 }}
            viewport={{ once: true, amount: 0.3 }}
          ...
          <motion.div
            className="absolute top-[255px] right-11 text-orange-600 text-20px font-bold text-center"
            initial={{ x: 100, opacity: 0 }}
            whileInView={{ x: 0, opacity: 1 }}
            viewport={{ once: true, amount: 0.3 }}
            transition={{ duration: 0.6, delay: 0.1 }}
          ...
          <motion.div
            className="absolute top-[460px] left-9 text-slate-700 text-20px font-bold text-center"
            initial={{ x: -100, opacity: 0 }}
            whileInView={{ x: 0, opacity: 1 }}
            viewport={{ once: true, amount: 0.3 }}
            transition={{ duration: 0.6, delay: 0.1 }}
        ...
        <div className="relative mt-10 text-start pl-6 lg:hidden z-10">
          ...
          <p className="text-slate-600 text-xl pt-4 mb-10">
            With exit points tailored to your goals, our{" "}
            <span className="text-orange-600 font-semibold">NSQF-certified</span>{" "}
            program offers flexibility
          </p>
