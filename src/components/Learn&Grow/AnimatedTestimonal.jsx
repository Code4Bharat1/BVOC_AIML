...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="text-white mx-auto max-w-sm px-4 py-20 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12">
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <img
                    ...
                    height={500}
                    draggable={false}
                    className="h-full w-full rounded-3xl object-cover object-center border-4 border-gray-800 shadow-lg"
                  />
                </motion.div>
              ))}
            </AnimatePresence>
