        ...
        <div className="bg-[#0f0f1a] min-h-screen py-16 px-4">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="md:hidden">
                    ...
                    >
                        {/* Card Content */}
                        <div className="bg-[#1a1a2e] relative z-10 h-[450px] overflow-hidden border-2 border-purple-500 rounded-t-lg
                            ...
                            <div className="p-6 flex flex-col">
                                <h3 className="text-white text-2xl font-bold mb-4 text-center">{cards[activeIndex].title}</h3>
                        ...
                        <div className="absolute w-full h-full bottom-0 left-0 
                          [clip-path:polygon(0_0,100%_0,100%_100%,0_92%)] 
                          bg-purple-600/20 -z-10 transform translate-y-2"></div>
                        ...
                        <div className="mt-12 flex flex-col items-center">
                            ...
                            {/* Next/Prev Buttons with Fixed Layout */}
                            <div className="flex justify-center items-center w-full gap-12">
                                ...
                                {/* Auto-rotation indicator - repositioned */}
                                <div className={`${isPaused ? 'opacity-0' : 'opacity-100'} transition-opacity duration-300 w-4 h-4 flex items-center justify-center`}>
