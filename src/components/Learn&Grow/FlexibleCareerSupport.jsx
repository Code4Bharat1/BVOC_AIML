        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="pt-4">
                <Link
                  href="/contact"
                  aria-label="Contact Nexcore Institute for career support"
            ...
            <div className="relative">
              ...
              <div className="relative">
                <Image
                  ...
                  alt="Career placement support and training at Nexcore Institute"
                  width={600}
                  height={400}
          ...
          <div className="mt-20 bg-white rounded-3xl p-10 shadow-lg border border-slate-200">
            ...
            <p className="text-xl text-slate-600 max-w-3xl">
              ...
              <strong className="text-orange-600">NSQF-certified</strong>{" "}
      ...
      <div className="block lg:hidden py-16 px-6">
        ...
        <div className="mb-10">
          <div className="relative bg-white rounded-2xl p-4 shadow-lg">
            <Image
              src="/path-to-left-image2.svg"
              alt="Career support and job placement training"
              width={400}
              height={300}
        ...
        <Link
          href="/contact"
          aria-label="Start your career journey with Nexcore Institute"
