...
const Footer = () => {
    return (
      <div className="bg-[#0f0f0f] text-lime-400 py-10 px-6">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="hover:text-lime-400">
                <i className="fab fa-instagram text-xl text-white"></i> {/* Instagram icon */}
              </a>
              <a href="#" className="hover:text-lime-400">
                <i className="fab fa-linkedin text-xl text-white"></i> {/* LinkedIn icon */}
              </a>
            </div>
          </div>
        </div>
