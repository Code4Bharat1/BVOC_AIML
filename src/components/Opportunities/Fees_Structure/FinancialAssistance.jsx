  ...
  const cards = [
    {
      ...
      description:
        "Merit-based, need-based, and Women-in-Tech scholarships help deserving students pursue advanced education in AI, Data Science, and Multimedia programs.",
    },
    {
      icon: <FaBriefcase />,
      title: "Paid Internships",
      description:
        "Students can gain real industry exposure through paid internships starting from the 2nd year, earning ₹3,000–₹10,000 per month.",
    },
    {
      icon: <FaHandHoldingUsd />,
      title: "Flexible Payment Plans",
      description:
        "Flexible installment plans may be considered for students facing genuine financial hardship, ensuring education remains accessible.",
    },
  ];

  return (
    <section
      aria-labelledby="financial-assistance-heading"
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <header className="text-center mb-16">
          <div className="inline-flex items-center gap-2 mb-6 px-6 py-2 bg-cyan-500/10 border-2 border-cyan-500/30 rounded-full">
            <HiSparkles className="text-cyan-400" aria-hidden="true" />
        ...
        <div className="hidden md:block relative py-12">
          ...
          <div className="flex justify-start mb-16 animate-fadeIn">
            <article className="relative group max-w-lg">
              ...
              <div className="relative bg-[#1a2847] rounded-3xl p-8 border-2 border-cyan-500/50 transform transition-all duration-500 hover:scale-105">
                ...
                <div className="flex items-start gap-4 mb-4">
                  <div
                    className="flex-shrink-0 w-16 h-16 rounded-xl bg-gradient-to-br from-cyan-500 to-purple-500 flex items-center justify-center text-white text-2xl shadow-lg shadow-cyan-500/50"
                    aria-hidden="true"
                  >
                    {cards[0].icon}
                  </div>
          ...
          <div className="flex justify-center mb-16 animate-fadeIn delay-200">
            <article className="relative group max-w-lg">
              ...
              <div className="relative bg-[#1a2847] rounded-3xl p-8 border-2 border-cyan-500/50 transform transition-all duration-500 hover:scale-105">
                ...
                <div className="flex items-start gap-4 mb-4">
                  <div
                    className="flex-shrink-0 w-16 h-16 rounded-xl bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center text-white text-2xl shadow-lg shadow-orange-500/50"
                    aria-hidden="true"
                  >
                    {cards[1].icon}
                  </div>
          ...
          <div className="flex justify-end animate-fadeIn delay-400">
            <article className="relative group max-w-lg">
              ...
              <div className="relative bg-[#1a2847] rounded-3xl p-8 border-2 border-cyan-500/50 transform transition-all duration-500 hover:scale-105">
                ...
                <div className="flex items-start gap-4 mb-4">
                  <div
                    className="flex-shrink-0 w-16 h-16 rounded-xl bg-gradient-to-br from-purple-500 to-cyan-500 flex items-center justify-center text-white text-2xl shadow-lg shadow-purple-500/50"
                    aria-hidden="true"
                  >
                    {cards[2].icon}
                  </div>
            ...
            <article key={index} className="relative group">
              <div className="relative bg-[#1a2847] rounded-3xl p-6 border-2 border-cyan-500/50">
                ...
                <div className="flex flex-col items-center text-center">
                  <div
                    className="w-16 h-16 rounded-xl bg-gradient-to-br from-cyan-500 to-purple-500 flex items-center justify-center text-white text-2xl mb-4 shadow-lg"
                    aria-hidden="true"
                  >
                    {card.icon}
                  </div>
