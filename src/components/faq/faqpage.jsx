...
const faqs = [
  // ELIGIBILITY
  {
    ...
    question: "What academic qualifications are required to appear for the exam?",
  ...
  },
  {
    ...
    answer: "Yes, students from all streams (Science, Commerce, Arts) can apply."
  },
  {
    category: "eligibility",
    question: "What is the minimum percentage required to be eligible?",
    answer: "There is no minimum percentage requirement. 12th appearing and 12th pass students are both eligible."
  },
  {
    category: "eligibility",
  ...
  {
    category: "eligibility",
    question: "Do students from other universities or colleges qualify to apply?",
    answer: "Yes, students from other universities or colleges can apply."
  },
  {
    category: "eligibility",
    question: "Can students with a gap year apply?",
    answer: "Yes, students with gap years are eligible to apply for the scholarship exam and admission."
  },
  {
    category: "eligibility",
    question: "Can international students apply for the B.Voc program?",
    answer: "Yes, international students may apply, subject to eligibility criteria and documentation."
  },
  ...
  },
  {
    ...
    answer: "Results will be declared tentatively within 15 days after the exam."
  },
  {
    category: "exam",
    question: "What happens if I miss the scholarship exam dates?",
    answer: "Students who miss the exam dates may not be eligible for that session's scholarship opportunity. Late applicants usually cannot appear — apply before the registration deadline."
  },
  ...
  },
  {
    ...
    answer: "Scholarship seats are limited and allocated based on merit in the scholarship exam. 250 seats are available this year."
  },
  {
    category: "scholarship",
    question: "Is the scholarship valid for the entire degree duration?",
    answer: "Yes, once awarded, the scholarship is valid for the full degree program."
  },
  {
    category: "scholarship",
    question: "Are there performance or attendance criteria to continue the scholarship?",
    answer: "Students may be required to maintain minimum attendance and academic performance to retain the scholarship."
  },
  {
    category: "scholarship",
    question: "Can the scholarship be transferred to another program?",
    answer: "No, the scholarship is applicable only to the selected B.Voc specialization. Scholarship benefits are generally specific to the B.Voc program in which you enrolled."
  },
  {
    category: "scholarship",
    question: "Is the scholarship renewable each year?",
    answer: "The scholarship is typically valid for the full degree duration once awarded."
  },
  ...
  },
  {
    ...
    answer: "Yes, the curriculum is designed according to current industry requirements with practical exposure. The curriculum includes hands-on projects and internship-focused learning."
  },
  {
    category: "program",
    question: "Are internships included in the B.Voc program?",
    answer: "Yes, internships and live projects are integrated into the course structure. Internships and real-world project work are part of the program."
  },
  {
    category: "program",
    question: "Will I receive certifications besides the degree?",
    answer: "Many programs include industry certifications along with the degree."
  },
  {
    category: "program",
    question: "Are online classes available?",
    answer: "Some components may be offered online or in hybrid mode depending on the schedule."
  },
  {
    category: "program",
  ...
  {
    category: "program",
    question: "Is there a campus visit or counselling session available before admission?",
    answer: "Yes, students can attend career counselling sessions and schedule a campus visit before taking admission."
  },
  {
    category: "program",
    question: "Is academic counselling provided before registration?",
    answer: "Yes, free career guidance and counselling support is available for students. Free career guidance sessions help students pick the right program."
  },
  ...
  // CAREER & PLACEMENT
  {
    ...
    answer: "Yes, graduates can pursue careers in AI, Data Science, Software Development, Multimedia Design, Animation, VFX, and related industries."
  },
  {
    category: "career",
    question: "Does the institute provide placement assistance?",
    answer: "Yes, structured placement support, resume building guidance, and interview preparation are provided. Structured placement support, resume coaching, and industry connections are available."
  },
  {
    category: "career",
    question: "Can students pursue higher education after completing B.Voc?",
    answer: "Yes, students can pursue postgraduate studies or specialized diploma programs after graduation. Many students pursue postgraduate studies or specialist diplomas after completing the B.Voc degree."
  },
];
        ...
        <div style={{ maxWidth: "72rem", margin: "0 auto", position: "relative", zIndex: 10 }}>
          ...
          >
            ...
            <p style={{
              ...
              Everything you need to know about the ₹25 Lakh Scholarship Program 2026
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                transition: "all 0.3s",
                boxShadow: activeCategory === "all" ? "0 4px 12px rgba(0, 102, 204, 0.3)" : "none"
              }}
            >
              All Questions
            </button>
          ...
          {filteredFAQs.length === 0 ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
              {filteredFAQs.map((faq, index) => {
                ...
                const categoryInfo = categories.find(c => c.category === faq.category);
      ...
      <section style={{
        ...
        <div style={{ maxWidth: "48rem", margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{
            ...
            Our admissions team is here to help you with any queries about the scholarship program.
          </p>
          <div style={{
            display: "flex",
            flexWrap: "wrap",
            ...
            <a
              href="https://wa.me/919594402822?text=Hi%2C%20I%20have%20questions%20about%20the%20scholarship%20program."
              target="_blank"
