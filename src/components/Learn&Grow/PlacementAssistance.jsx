  ...
  return (
    <section className="relative w-full overflow-x-hidden px-4 sm:px-6 py-12 sm:py-16 md:py-20 bg-white">
      ...
      <div className="relative max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-10 z-10">
        {/* Left Side Image */}
        <div className="w-full lg:w-1/2 flex justify-center slide-left">
          <div className="relative w-full max-w-md lg:max-w-none">
            <Image
              ...
              width={500}
              height={300}
              className="placement-image rounded-2xl sm:rounded-3xl w-full object-cover shadow-xl border-2"
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-start slide-right">
          ...
          >
            ...
            <span className="font-bold" style={{ color: '#FF7F00' }}>intern</span> and{" "}
            <span className="font-bold" style={{ color: '#FFCD00' }}>work</span>. Our{" "}
            <span className="font-bold" style={{ color: '#007BFF' }}>
