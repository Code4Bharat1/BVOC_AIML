...
const AllSemesters = () => {
  ...
  return (
    <section
      ...
      aria-labelledby="semester-curriculum-heading"
    >
      {/* ===== HEADER ===== */}
      <div className="text-center py-16 px-4">
        ...
        {/* H1 improves SEO */}
        <h1
          id="semester-curriculum-heading"
        ...
        {semesters.map((semester, index) => (
          ...
          >
            <div
              ...
              role="button"
              aria-label={`Preview curriculum for ${semester.name}`}
            ...
            >
              ...
              <button
                aria-label={`Preview ${semester.name} curriculum PDF`}
                className="mt-4 text-sm font-semibold text-[#FF7F00]"
              >
                Preview →
              </button>
            </div>
      ...
      <div className="md:hidden max-w-xl mx-auto px-4 pb-20 space-y-6">
        {semesters.map((semester) => (
          ...
          >
            ...
            <button
              aria-label={`Preview and download ${semester.name} curriculum`}
              className="mt-3 text-sm font-semibold text-[#FF7F00]"
            >
              Preview & Download →
            </button>
          </article>
      ...
      {isModalOpen && selectedSemester && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label={`${selectedSemester.name} Curriculum Preview`}
        >
          <div
          ...
          >
            ...
            <iframe
              ...
              title={`${selectedSemester.name} Curriculum PDF Preview`}
            />
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-3 mt-5">
              ...
              <button
                ...
                aria-label={`Download ${selectedSemester.name} curriculum PDF`}
