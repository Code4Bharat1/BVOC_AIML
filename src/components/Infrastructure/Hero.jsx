...
const Hero = () => {
  return (
    <>
      <Head>
        {/* Basic SEO */}
        <title>World-Class Infrastructure | BVOC AI & ML Program</title>
        <meta
          name="description"
          content="Explore state-of-the-art labs, smart classrooms, and innovation hubs at our BVOC AI & ML program. Built to empower hands-on learning, creativity, and real-world simulation."
        />
        <meta
          name="keywords"
          content="BVOC AI ML infrastructure, smart classrooms, state of the art labs, innovation hub, AI ML college infrastructure, hands-on learning, technology labs, BVOC program facilities"
        />
        ...
        {/* Open Graph */}
        <meta property="og:title" content="World-Class Infrastructure | BVOC AI & ML Program" />
        <meta
          property="og:description"
          content="High-tech learning spaces, smart classrooms, and innovation hubs designed for AI & ML students."
        />
        <meta property="og:url" content="https://yourwebsite.com/infrastructure" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://yourwebsite.com/images/infrastructure-og.jpg" />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="World-Class Infrastructure | BVOC AI & ML Program" />
        <meta
          name="twitter:description"
          content="State-of-the-art labs, smart classrooms and innovation hubs for AI & ML learners."
        />
        <meta name="twitter:image" content="https://yourwebsite.com/images/infrastructure-og.jpg" />
      </Head>
