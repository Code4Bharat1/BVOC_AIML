...
const SelectionAndPerformanceCards = () => {
  ...
  return (
    <>
      ...
      <Head>
        <title>
          Internship Selection Process & Performance Review | B.Voc AI & ML
        </title>

        <meta
          name="description"
          content="Learn about the internship selection process and performance review system for the B.Voc AI & ML program. Students are evaluated through skill assessments, interviews, and monthly performance reviews."
        />

        <meta
          name="keywords"
          content="AI ML internship selection process, AI ML internship performance review, B.Voc AI ML internship selection, AI ML internship evaluation, student internship review process, AI ML internship program"
        />
        ...
        <meta
          property="og:title"
          content="Internship Selection Process & Performance Review | B.Voc AI & ML"
        />
        <meta
          property="og:description"
          content="Understand how students are selected and evaluated in the B.Voc AI & ML internship program through skill assessments, interviews, and performance reviews."
        />
        <meta
          property="og:url"
        ...
        <meta
          ...
          content="Explore the internship selection process, evaluation criteria, and performance review system for AI & ML students."
        />
        <meta
          name="twitter:image"
          content="https://yourdomain.com/og-image.jpg"
